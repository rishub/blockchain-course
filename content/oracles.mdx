...
Here is an example of how blockchain and oracles can be used in supply chain. We start with the ideal timeline of an item being imported to the US. We will see in the second timeline how this is not always realistic, and things like tampering are possible. Finally, we will see how oracles can be used to solve this problem in the 3rd timeline.
<OracleExamples />
