...
Just as a disclaimer, this page won’t be going into every project relating to oracles. There has been a lot of criticism of Chainlink specifically as Coinbase oracles have come out, and we consider it unproductive to introduce that sort of discussion into this course. Instead, we will cover the technical attributes of oracles so that it will be easier for others to make their own analysis of these systems.

## Basic Blockchain Use Cases
Blockchain is one of the hottest emerging technology in our world today. Boasting a (somewhere around - who knows with the volatility) $300 billion value of Cryptocurrency alone, the potential is clearly huge. Smart contracts have come around and exponentially expanded the possibilities for Blockchain technology, for use cases such as:
...
However, each of these use cases leave one question unanswered: for any distributed application which wants to leverage real world data, such as a betting contract determining which sports team won a game, how does that application get that information on-chain in reliable, trusted manner?
...
// find citation for "!!!!!!!!" part, I think it's about 10%

Blockchain gambling has begun to take a large chunk of that market: !!!!!!!!!!!!!!. It is typically nearly impossible to reliably determine and verify the results of many things that are used for gambling. For example, a game as simple as blackjack could be rigged in favor of the dealer to the tune of 1% gambling volume per day. With a smart contract, online gambling can be verifiably fair with transparency around any dealer biases present in games. However, many areas of online gambling are not as simple as blackjack. In sports betting, without an oracle, you cannot determine which team won a game; as a result, sports betting requires some sort of oracle. For a game like the Superbowl, these contracts may begin to yield tens or hundreds of millions of dollars, creating a massive financial incentive for oracles to behave dishonorably (i.e. maliciously).
...
// side thought: mention that while traditional online gambling companies are tied to an established legal entity that could be sued in case of illegitimate behavior, smart contracts for gambling can be somewhat anonymous.
